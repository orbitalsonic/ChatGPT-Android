package com.orbitalsonic.chatgpt.helpers.utils
...
import com.orbitalsonic.chatgpt.helpers.firebase.FirebaseUtils.recordException
        ...
        this?.let {
            try {
                startActivity(
                    Intent(
                        Intent.ACTION_VIEW,
                        Uri.parse("https://play.google.com/store/account/subscriptions?package=${it.packageName}")
                    )
                );
            } catch (ex: ActivityNotFoundException) {
